...
import { Typography, Box, Select, MenuItem, Button, Alert, List, ListItem, ListItemText, TextField } from "@mui/material"
        ...
        <List>
          {games.map((game: any) => (
            <ListItem key={game.id}>
              <ListItemText primary={`${game.title} (Theme: ${game.theme?.name || "Unknown"})`} />
              <Button
